...
. In the directory you extracted your "Hello World" project to:
...
+
----
$ java -Dserver.port=8095 -jar target/hello-spring-boot-0.0.1-SNAPSHOT.jar
----

. Visit the application in the browser (http://localhost:8095), and verify that the output is still the following:
+
----
Hello World!
----
...
+
----
$ GREETING=Ohai java -Dserver.port=8095 -jar target/hello-spring-boot-0.0.1-SNAPSHOT.jar
----

. Visit the application in the browser (http://localhost:8095), and verify that the output has changed to the following:
+
----
Ohai World!
----
...
+
----
$ SPRING_PROFILES_ACTIVE=spanish java -Dserver.port=8095 -jar target/hello-spring-boot-0.0.1-SNAPSHOT.jar
----
...
+
----
$ SPRING_PROFILES_ACTIVE=spanish GREETING=Ohai java -Dserver.port=8095 -jar target/hello-spring-boot-0.0.1-SNAPSHOT.jar
----
